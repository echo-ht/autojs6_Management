...
class App : MultiDexApplication() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            startForegroundService(Intent(this, org.autojs.autojs.network.ManagementPlatformService::class.java))
        } else {
            startService(Intent(this, org.autojs.autojs.network.ManagementPlatformService::class.java))
        }
    }
