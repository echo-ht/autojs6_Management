...
import org.autojs.autojs.network.ManagementPlatformScriptExecutionListener
...
open class AutoJs(appContext: Application) : AbstractAutoJs(appContext) {
    ...
    init {
        ...
        scriptEngineService.registerGlobalScriptExecutionListener(ManagementPlatformScriptExecutionListener())
