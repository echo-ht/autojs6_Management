...
object Pref {
    ...
    @JvmStatic
    fun getManagementPlatformServerAddress(): String = getString(R.string.key_management_platform_server_address, getServerAddress())

    @JvmStatic
    fun setManagementPlatformServerAddress(address: String?) = putString(R.string.key_management_platform_server_address, address)

    @JvmStatic
    fun getManagementPlatformSecret(): String = getStringOrNull(R.string.key_management_platform_secret) ?: ""

    @JvmStatic
    fun setManagementPlatformSecret(secret: String?) = putString(R.string.key_management_platform_secret, secret)
